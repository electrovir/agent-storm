...
- Worktrees can record a parentTaskPath; blocked parents render dimmed with a red x naming blockers, sorted last.
- Deleting a worktree clears parentTaskPath references on any worktrees that pointed at it.
